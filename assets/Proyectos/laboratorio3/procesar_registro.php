...
if (isset($_POST['correoRegistro']) && isset($_POST['nombreCompletoRegistro']) && isset($_POST['nombreUsuarioRegistro']) && isset($_POST['contrasenaRegistro'])) {
    ...
    // Usar la clase Encriptacion para encriptar la contraseña antes de guardarla en la base de datos
    $contrasenaHash = Encriptacion::encriptarContrasena($contrasena);
